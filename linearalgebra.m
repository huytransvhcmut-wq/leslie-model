...
second_age_class = input ("The number of people in the second age class(between 20 and 40 years old): ");
...
Y = [first_age_class  second_age_class  third_age_class]; % present population
future_population = X * X * Y'; % population after 40 years
fprintf("The number of people there will be in the third age class after 40 years: %d\n",future_population(3,1));
% The number of people there were in the third age class 20 years ago
past_population = pinv(X) * Y'; % population 20 years ago
